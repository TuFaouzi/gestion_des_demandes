...
<div class="<?= uri_string() == "employee/add-request" ? 'nav__selected' : '' ?>">
    <a class="link AppLayout__nav__main__icon"
    href="<?= site_url('/employee/add-request') ?>"
    >
    ...
    <div class="AppLayout__nav__main__content">
        <a class="link AppLayout__nav__main__content" href="<?= site_url('/employee/add-request') ?>">Poser une requête</a>
    </div>
</div>
<?= $this->endSection() ?>
